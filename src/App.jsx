...
function App() {
  ...
  const [totalHours, setTotalHours] = useState([
    ...
    {amount: Number(localStorage.getItem('bonusHours')) || 0, type: 'bonusHours'},
  ])
  ...
  return (
    <>
      ...
      <section className='hoursSection'>
        {HOURSOBJ.map(({ header, description, shiftType, initialValue }, index) => (
          <Hours 
            key={index}
            header={header}
